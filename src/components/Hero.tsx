  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-10 w-20 h-20 rounded-full bg-spice-turmeric animate-pulse" />
        <div className="absolute top-40 right-20 w-16 h-16 rounded-full bg-spice-green animate-pulse delay-700" />
        <div className="absolute bottom-40 left-20 w-12 h-12 rounded-full bg-spice-orange animate-pulse delay-1000" />
        <div className="absolute bottom-20 right-40 w-24 h-24 rounded-full bg-spice-red animate-pulse delay-500" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 font-merriweather leading-tight">
            Purity is the{' '}
            <span className="text-spice-turmeric">Essence</span>
            {' '}of Our Brand
          </h1>
