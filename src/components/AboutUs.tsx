...
const metaTitle = "About Us | Unnati Masale - Premium Indian Spices Manufacturer";
const metaDescription =
  "Discover the story of Unnati Masale, a leading manufacturer of premium Indian spices. Learn about our heritage, commitment to purity, quality sourcing, and our vision to deliver authentic flavors across India and beyond.";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://unnatimasale.com/about" />
        <meta property="og:image" content="https://unnatimasale.com/og-image.jpg" />
        <link rel="canonical" href="https://unnatimasale.com/about" />
      </Helmet>
